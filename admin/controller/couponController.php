        ...
        if(isset($coupon_id) && $coupon_id == ""){
            ...
            if($return){
                ...
                foreach ($cuponUser as $key=>$users){
                    ...
                    $subject = 'Lynsbistro offering a discount of '.$amount;
                    $body 	 = '<p>Dear '.$users["full_name"].',</p><p>You have been offered '. $amount.' discount on your order in Lynsbistro. 
                        ...
                        <p>Best Regards</p><p>Lynsbistro</p><p>Note: Please Do not reply this email.</p>';
            ...
            if($return){
                ...
                foreach ($cuponUser as $key=>$users){
                    ...
                    $body 	 = '<p>Dear '.$users["full_name"].'</p>You have been offered '. $amount.' discount on your order in OurBurritoBrothers. 
                        ...
                        Best Regards</p><p><b>Lynsbistro</b></p><p>Note: Please Do not reply this email.</p>';
