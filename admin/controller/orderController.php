...
//var_dump($status_id);
        ...
        if($return){
            ...
            //$subject = "Your order no #$order_id has been $subject by Lynsbistro";
            //$body 	 = "Dear ".$email['full_name']."<br>Your order". $order_id." has been". $subject." by Lynsbistro. <br>Thanks<br>Our BurritoBrothers";


            if($status_id == 2){
                $subject = "Your order no #".$order_id." has been Rejected/Canceled by Lynsbistro";
                $body 	 = "<p>Dear ".$email['full_name']."</p><p>We  apologise but we cannot fulfill  your order ". $order_id."   at this time. </p><p>You may contact the store at  ".$contactNo." for more information.</p><p>Thank You,</p><p>Lynsbistro</p>";
                $dbClass->sendMail($email['email'], $subject, $body);
            }
            else if($status_id == 3){
                $subject = $order_id." Order ".$email['full_name']." Confirmation from Lynsbistro ";
                $body 	 = "<p>Dear ".$email['full_name']."</p><p>Your order". $order_id." has been Received by Lynsbistro. </p><p>Thanks</p><p>Lynsbistro</p>";
                $dbClass->sendMail($email['email'], $subject, $body);
                ...
                $body 	 = "<p>Dear ".$email['full_name']."</p><p>Your order ". $order_id." has been Ready for  pick. </p><p>Thanks</p><p>Lynsbistro</p>";
                $dbClass->sendMail($email['email'], $subject, $body);
            }
            else if($status_id == 5){
                //$details = " Your Order (".$order_id.") is Delivered ";
                $subject = "Your order no #".$order_id." has been picked up.";
                $body 	 = "<p>Dear ".$email['full_name']."</p><p>Your order". $order_id." has been picked up </p><p>Thanks</p><p>Lynsbistro</p>";
                $dbClass->sendMail($email['email'], $subject, $body);
            }
...
//var_dump($status_id);
        ...
        if($return){
            ...
            $body 	 = "<p>Dear ".$email['full_name'].",</p><p>We apologise that we  are not able to fulfill your order ". $order_id."
                A refund of ".$id['total_paid_amount']." has been issued. </p><p>Thank you for patronage.</p><p>Sincerley.</p><p>Lynsbistro</p>";
            $dbClass->sendMail($email['email'], $subject, $body);
