                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-3 col-xs-6" style="cursor:pointer">
                            <div class="service-track-inner btn-shadow" >
                                ...
                                <div class="service-track-overlay banner-bg" style="background-color:rgb(235, 129, 129)" onclick="pickup_order()">
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-6" style="cursor:pointer">
                            <div class="service-track-inner btn-shadow" id="groupOrder">
                                ...
                                <div class="service-track-overlay banner-bg" onclick="delivery_order()" style="background-color: rgb(235, 129, 129)">
                                    <img src="./images/img36.png" alt="" style="max-height: 50px !important;">
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-6" style="cursor:pointer">
                            <div class="service-track-inner btn-shadow" >
                                ...
                                <div class="service-track-overlay banner-bg" style="background-color: rgb(235, 129, 129)" onclick="group_order()">
                                    <img src="./images/img36.png" alt="" style="max-height: 50px !important;">
                                    <h3>Group <span>Order</span></h3>
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-6" style="cursor:pointer">
                            <div class="service-track-inner btn-shadow" id="groupOrder">
                                ...
                                <div class="service-track-overlay banner-bg" onclick="catering()" style="background-color: rgb(235, 129, 129)">
                                    <img src="./images/img36.png" alt="" style="max-height: 50px !important;">
                                    <h3>Catering <span>Service</span></h3>
